...
public class Contact implements java.io.Serializable {
    ...
    public Contact() {
        ...
        this.dateAnnee = 1970;        
        this.numeroTelephone = "0605040302";
        this.email = "tarace.boulba@tamere.com";
     ...
     * @param hobby un hobby
     * @return True si le hobby est dans la liste
     */
    public boolean removeHobby(Hobby hobby) {
        if (hobby == null) {
            // hobby ne peut pas être null (on n'insère pas les null dans l'ensemble => on ne peut pas les en supprimer)
            return false ;
        }
        
        if (!hobbies.contains(hobby)) {
            // L'ensemble ne contient pas le hobby qu'on cherche à supprimer
            return false ;
        }
    ...
    public void afficherDansConsole() {
        ...
        System.out.println("telephone : " + this.getNumeroTelephone());
        System.out.println("date de naissance : " + this.getDateNaissance()) ;
        System.out.println("dispo : " + this.getDisponibilite());
